...
class RequestMsg :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_cmdtype() const;
  void _internal_set_cmdtype(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
class RespondMsg :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_seckeyid() const;
  void _internal_set_seckeyid(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int64 RequestMsg::_internal_cmdtype() const {
  return cmdtype_;
}
...
inline void RequestMsg::_internal_set_cmdtype(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 RespondMsg::_internal_seckeyid() const {
  return seckeyid_;
}
...
inline void RespondMsg::_internal_set_seckeyid(::PROTOBUF_NAMESPACE_ID::int64 value) {
